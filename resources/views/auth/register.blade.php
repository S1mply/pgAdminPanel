...
<div class="login-box">
    ...
    <div class="login-box-body">
        ...
        <div class="form-group has-feedback">
            {!! Form::input('name', 'name','', ['class'=>'form-control','placeholder' =>'Full name']) !!}
        ...
        <div class="form-group has-feedback">
            {!! Form::input('password', 'password_confirmation','',['class'=>'form-control','placeholder' =>'Retype password']) !!}
        ...
        <div class="form-group has-feedback">
            {!! Form::input('text', 'company','',['class'=>'form-control','placeholder' =>'company']) !!}
            <span class="glyphicon glyphicon-education form-control-feedback"></span>
        </div>
        <div class="form-group has-feedback">
            {!! Form::select('role', ['admin' => 'Admin', 'person' => 'Person','client' => 'Client'], 'client', ['class' => 'form-control']) !!}
        </div>
        <div class="row">
            <div class="col-xs-4">
